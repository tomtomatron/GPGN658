...
%question 1
\multiplot{2}{R1bd,R1bn}{width=0.45\textwidth}{Images from CIC using a constant density model with and without direct arrival in data.)
\multiplot{2}{R2bd,R2bn}{width=0.45\textwidth}{Images from deconvolution using a constant density model with and without direct arrival in data.)

%question 2
\multiplot{2}{R1ad,R1an}{width=0.45\textwidth}{Images from CIC using a vertically varying density model with and without direct arrival in data.)
\multiplot{2}{R2ad,R2an}{width=0.45\textwidth}{Images from deconvolution using a constant density model with and without direct arrival in data.)
