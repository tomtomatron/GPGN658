...
%question 1
\multiplot{2}{Rb01,Rb11}{width=0.45\textwidth}{Images from CIC using a constant density model with and without direct arrival in data.}
%\multiplot{2}{Rb02,Rb12}{width=0.45\textwidth}{Images from deconvolution using a constant density model with and without direct arrival in data.}

%question 2
\multiplot{2}{Ra01,Ra11}{width=0.45\textwidth}{Images from CIC using a vertically varying density model with and without direct arrival in data.}
%\multiplot{2}{Ra01,Ra12}{width=0.45\textwidth}{Images from deconvolution using a vertically varying density model with and without direct arrival in data.}
